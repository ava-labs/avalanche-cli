...
func clean(*cobra.Command, []string) error {
	...
	config1NodeEnabled := app.Conf.GetConfigBoolValue(constants.Config1NodeEnabledKey)

	if err := subnet.SetDefaultSnapshot(app.GetSnapshotsDir(), true, config1NodeEnabled); err != nil {
