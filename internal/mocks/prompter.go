...
// CaptureUint64Compare provides a mock function with given fields: promptStr, comparatorsp
func (_m *Prompter) CaptureUint64Compare(promptStr string, comparatorsp []prompts.Comparator) (uint64, error) {
	ret := _m.Called(promptStr, comparatorsp)

	var r0 uint64
	var r1 error
	if rf, ok := ret.Get(0).(func(string, []prompts.Comparator) (uint64, error)); ok {
		return rf(promptStr, comparatorsp)
	}
	if rf, ok := ret.Get(0).(func(string, []prompts.Comparator) uint64); ok {
		r0 = rf(promptStr, comparatorsp)
	} else {
		r0 = ret.Get(0).(uint64)
	}

	if rf, ok := ret.Get(1).(func(string, []prompts.Comparator) error); ok {
		r1 = rf(promptStr, comparatorsp)
	} else {
		r1 = ret.Error(1)
	}
...
// ChooseKeyOrLedger provides a mock function with given fields:
func (_m *Prompter) ChooseKeyOrLedger() (bool, error) {
	ret := _m.Called()
