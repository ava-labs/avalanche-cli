...
// CaptureEmail provides a mock function with given fields: promptStr, arg
func (_m *Prompter) CaptureEmail(promptStr string, arg interface{}) (interface{}, error) {
	ret := _m.Called(promptStr, arg)
...
// CaptureSemanticVersion provides a mock function with given fields: promptStr
func (_m *Prompter) CaptureSemanticVersion(promptStr string) (*version.Semantic, error) {
	ret := _m.Called(promptStr)

	var r0 *version.Semantic
	if rf, ok := ret.Get(0).(func(string) *version.Semantic); ok {
		r0 = rf(promptStr)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*version.Semantic)
		}
	}
