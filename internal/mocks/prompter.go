...
func (_m *Prompter) CaptureIndex(promptStr string, options []any) (int, error) {
	...
	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(string, []any) (int, error)); ok {
...
// CaptureUint16 provides a mock function with given fields: promptStr
func (_m *Prompter) CaptureUint16(promptStr string) (uint16, error) {
	ret := _m.Called(promptStr)

	if len(ret) == 0 {
		panic("no return value specified for CaptureUint16")
	}
...
// CaptureUint8 provides a mock function with given fields: promptStr
func (_m *Prompter) CaptureUint8(promptStr string) (uint8, error) {
	ret := _m.Called(promptStr)

	if len(ret) == 0 {
		panic("no return value specified for CaptureUint8")
	}
