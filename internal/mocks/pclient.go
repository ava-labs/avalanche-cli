...
import (
	avalanchegoapi "github.com/ava-labs/avalanchego/api"
...
// GetCurrentL1Validators provides a mock function with given fields: ctx, subnetID, nodeIDs, options
func (_m *PClient) GetCurrentL1Validators(ctx context.Context, subnetID ids.ID, nodeIDs []ids.NodeID, options ...rpc.Option) ([]api.APIL1Validator, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetCurrentL1Validators")
	}

	var r0 []api.APIL1Validator
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ids.ID, []ids.NodeID, ...rpc.Option) ([]api.APIL1Validator, error)); ok {
		return rf(ctx, subnetID, nodeIDs, options...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ids.ID, []ids.NodeID, ...rpc.Option) []api.APIL1Validator); ok {
		r0 = rf(ctx, subnetID, nodeIDs, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]api.APIL1Validator)
		}
	}
...
func (_m *PClient) GetRewardUTXOs(_a0 context.Context, _a1 *avalanchegoapi.GetTxArgs, _a2 ...rpc.Option) ([][]byte, error) {
	...
	var r0 [][]byte
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *avalanchegoapi.GetTxArgs, ...rpc.Option) ([][]byte, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *avalanchegoapi.GetTxArgs, ...rpc.Option) [][]byte); ok {
		r0 = rf(_a0, _a1, _a2...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([][]byte)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *avalanchegoapi.GetTxArgs, ...rpc.Option) error); ok {
		r1 = rf(_a0, _a1, _a2...)
	} else {
		r1 = ret.Error(1)
	}
...
// GetValidatorFeeConfig provides a mock function with given fields: ctx, options
func (_m *PClient) GetValidatorFeeConfig(ctx context.Context, options ...rpc.Option) (*fee.Config, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetValidatorFeeConfig")
	}
...
// GetValidatorFeeState provides a mock function with given fields: ctx, options
func (_m *PClient) GetValidatorFeeState(ctx context.Context, options ...rpc.Option) (gas.Gas, gas.Price, time.Time, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetValidatorFeeState")
	}
	...
	var r2 time.Time
	var r3 error
	if rf, ok := ret.Get(0).(func(context.Context, ...rpc.Option) (gas.Gas, gas.Price, time.Time, error)); ok {
		return rf(ctx, options...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...rpc.Option) gas.Gas); ok {
		r0 = rf(ctx, options...)
	} else {
		r0 = ret.Get(0).(gas.Gas)
	}
...
func (_m *PClient) GetValidatorsAt(ctx context.Context, subnetID ids.ID, height api.Height, options ...rpc.Option) (map[ids.NodeID]*validators.GetValidatorOutput, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ids.ID, api.Height, ...rpc.Option) (map[ids.NodeID]*validators.GetValidatorOutput, error)); ok {
		return rf(ctx, subnetID, height, options...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ids.ID, api.Height, ...rpc.Option) map[ids.NodeID]*validators.GetValidatorOutput); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, ids.ID, api.Height, ...rpc.Option) error); ok {
