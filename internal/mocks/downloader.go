...
// GetAllReleasesForRepo provides a mock function with given fields: org, repo, kind
func (_m *Downloader) GetAllReleasesForRepo(org string, repo string, kind application.ReleaseKind) ([]string, error) {
	...
	var r0 []string
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, application.ReleaseKind) ([]string, error)); ok {
		return rf(org, repo, kind)
	}
	if rf, ok := ret.Get(0).(func(string, string, application.ReleaseKind) []string); ok {
		r0 = rf(org, repo, kind)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]string)
	...
	if rf, ok := ret.Get(1).(func(string, string, application.ReleaseKind) error); ok {
		r1 = rf(org, repo, kind)
	} else {
		r1 = ret.Error(1)
	}
