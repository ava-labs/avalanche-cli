...
// CreateBlockchains provides a mock function with given fields: ctx, blockchainSpecs, opts
func (_m *Client) CreateBlockchains(ctx context.Context, blockchainSpecs []*rpcpb.BlockchainSpec, opts ...client.OpOption) (*rpcpb.CreateBlockchainsResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, ctx, blockchainSpecs)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	var r0 *rpcpb.CreateBlockchainsResponse
	if rf, ok := ret.Get(0).(func(context.Context, []*rpcpb.BlockchainSpec, ...client.OpOption) *rpcpb.CreateBlockchainsResponse); ok {
		r0 = rf(ctx, blockchainSpecs, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, []*rpcpb.BlockchainSpec, ...client.OpOption) error); ok {
		r1 = rf(ctx, blockchainSpecs, opts...)
	} else {
		r1 = ret.Error(1)
	}
