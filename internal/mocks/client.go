...
func (_m *Client) ListSnapshots(ctx context.Context) ([]string, error) {
	ret := _m.Called(ctx)
...
// LoadSnapshot provides a mock function with given fields: ctx, snapshotName, inPlace, opts
func (_m *Client) LoadSnapshot(ctx context.Context, snapshotName string, inPlace bool, opts ...client.OpOption) (*rpcpb.LoadSnapshotResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, ctx, snapshotName, inPlace)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, bool, ...client.OpOption) (*rpcpb.LoadSnapshotResponse, error)); ok {
		return rf(ctx, snapshotName, inPlace, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, bool, ...client.OpOption) *rpcpb.LoadSnapshotResponse); ok {
		r0 = rf(ctx, snapshotName, inPlace, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, bool, ...client.OpOption) error); ok {
		r1 = rf(ctx, snapshotName, inPlace, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Client) SaveSnapshot(ctx context.Context, snapshotName string, force bool) (*rpcpb.SaveSnapshotResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) (*rpcpb.SaveSnapshotResponse, error)); ok {
		return rf(ctx, snapshotName, force)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) *rpcpb.SaveSnapshotResponse); ok {
		r0 = rf(ctx, snapshotName, force)
	} else {
		if ret.Get(0) != nil {
