...
var _ = ginkgo.Describe("[Etna AddRemove Validator SOV PoS flow]", func() {
	ginkgo.It("Can follow the full PoS flow", func() {
		...
		//	"Can initialize a PoS Manager contract"
		...
		//	"Can wait for min staking period to pass"
