...
var _ = ginkgo.Describe("[Node create with separate monitoring]", func() {
	ginkgo.It("can create a node with separate monitoring", func() {
		output := commands.NodeCreateWithMonitoring("fuji", 1)
		fmt.Println(output)
